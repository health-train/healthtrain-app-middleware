...
class InviteController extends AbstractController
{
    ...
    {
        $this->logger->info('Invite link used [InvitationId: ' . $invitationId. '] [userOrganisationConnectionId: ' . $userOrganisationConnectionId .']', array('properties' => array('type' => 'invite', 'action' => __FUNCTION__), 'invitationId' => $invitationId, 'userOrganisationConnectId', $userOrganisationConnectionId));
